...
python scripts/summarize_paramsweep.py \
  --results_directory 'param_sweep/param_sweep_adage_GREIN_rat/' \
  --output_filename 'param_sweep_adage_GREIN_full-results_rat.tsv'

python scripts/summarize_paramsweep.py \
  --results_directory 'param_sweep/param_sweep_tybalt_GREIN_rat/' \
  --output_filename 'param_sweep_tybalt_GREIN_full-results_rat.tsv'
...
# GREIN Mouse
python scripts/summarize_paramsweep.py \
  --results_directory 'param_sweep/param_sweep_adage_GREIN_mouse/' \
  --output_filename 'param_sweep_adage_GREIN_full-results_mouse.tsv'

python scripts/summarize_paramsweep.py \
  --results_directory 'param_sweep/param_sweep_tybalt_GREIN_mouse/' \
  --output_filename 'param_sweep_tybalt_GREIN_full-results_mouse.tsv'
